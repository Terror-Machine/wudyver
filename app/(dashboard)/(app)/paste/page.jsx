...
const PasteManager = () => {
  ...
  const DELETE_PASSWORD = apiConfig.PASSWORD; // Password untuk menghapus
  ...
  const handleDeletePaste = async (keyToDelete) => {
    ...
    const enteredPassword = prompt(`Untuk menghapus paste (Key: ${actualKey}), masukkan password:`);
    if (enteredPassword === null) { // User menekan cancel
  ...
  const handleClearAllPastes = async () => {
    if (window.confirm("Apakah Anda yakin ingin menghapus semua paste? Tindakan ini tidak dapat diurungkan.")) {
      // --- PERUBAHAN DIMULAI DI SINI ---
      const enteredPassword = prompt(`Untuk menghapus SEMUA paste, masukkan password:`);
      if (enteredPassword === null) { // User menekan cancel
  ...
  // Fungsi confirmDelete akan tetap memanggil handleDeletePaste yang sudah diproteksi password
  const confirmDelete = (key, pasteTitle) => {
    const titleDisplay = pasteTitle || "(Tanpa Judul)";
    // Konfirmasi awal tetap ada, password akan diminta di dalam handleDeletePaste
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 items-end">
                  ...
                  <div>
                    <Button
                      ...
                      onClick={() => handleDeletePaste()} // handleDeletePaste() akan meminta password
                    />
                  </div>
                </div>
              </div>
              ...
              <div className={sectionCardClass}>
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 gap-2">
                  ...
                  <Button
                    ...
                    onClick={handleClearAllPastes} // handleClearAllPastes() akan meminta password
                  />
                </div>
                          ...
                          <div className="flex flex-col sm:flex-row justify-between items-start mb-1.5">
                            ...
                            <div className="flex gap-1.5 self-start sm:self-center">
                              ...
                              <Button 
                                ...
                                onClick={() => confirmDelete(paste.key, paste.title)} // confirmDelete akan memanggil handleDeletePaste yang meminta password
