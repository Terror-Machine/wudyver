        ...
        footerContent={
          <div className="flex justify-end space-x-2">
            <Button
              ...
              className="max-w-md border border-teal-500/50 dark:border-teal-600/70 rounded-xl shadow-lg bg-white text-slate-800 dark:bg-slate-800/50 dark:text-slate-100 backdrop-blur-sm bg-opacity-80 dark:bg-opacity-80" // Style disesuaikan dengan yang ada di Card, namun mungkin lebih baik dibuat class khusus untuk button modal cancel
              disabled={loading}
            />
            <Button
