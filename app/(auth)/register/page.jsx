...
import RegForm from "@/components/partials/auth/reg-form"; // Pastikan nama file ini sudah benar
import Social from "@/components/partials/auth/social";
import useDarkMode from "@/hooks/useDarkMode";
import { useDispatch } from "react-redux";
import { fetchUsersFromAPI } from "@/components/partials/auth/store"; // Sesuaikan jika ini tidak relevan untuk register
...
const RegisterPage = () => {
  ...
  // Efek ini mungkin tidak diperlukan untuk halaman register kecuali Anda memang ingin mengambil data pengguna saat halaman register dimuat
  useEffect(() => {
      ...
      <div className="loginwrapper">
        <div className="lg-inner-column">
          <div className="right-column relative">
            <div className="inner-content h-full flex flex-col bg-white dark:bg-slate-800">
              <div className="auth-box h-full flex flex-col justify-center">
                ...
                <RegForm /> {/* Menggunakan komponen RegForm */}
          ...
          <div
            ...
            style={{
              backgroundImage: `url(/assets/images/all-img/login-bg.png)`, // Bisa diganti dengan gambar register jika ada
            }}
          >
