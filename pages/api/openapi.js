...
export default async function handler(req, res) {
  ...
  try {
    ...
    const openAPISpec = {
      ...
      servers: [{
        url: `https://api.${domainName}/v1`,
        description: `${domainName} Production API (${domainName}) - Akses Terbuka`,
        variables: {
          environment: {
            default: "production",
            enum: ["production", "development", "staging"],
            description: `Lingkungan deployment ${domainName} API.`
          },
          region: {
            default: "global",
            enum: ["global", "asia-pacific", "europe", "americas"],
            description: "Wilayah server untuk optimasi kinerja."
          }
        }
      }, {
        url: "http://localhost:5000/v1",
        description: `Server Pengembangan Lokal ${domainName}`
      }],
                ...
                examples: {
                  successfulQuery: {
                    value: {
                      ...
                      message: `Permintaan berhasil diproses oleh ${domainName}.`,
                      payload: {
                        resourceData: {
                          id: "ID_001",
                          name: "Generic Item",
                        ...
                        metadata: {
                          recordCount: 1,
                          apiVersion: "1.0.0-beta.release"
                        }
                      },
                      [`${domainName.replace(/\./g, "")}TraceId`]: "a1b2c3d4-e5f6-7890-1234-567890abcdef",
                      processingTimeMs: 8
                    }
                  }
                }
              ...
              "application/json": {
                ...
                examples: {
                  invalidInput: {
                    value: {
                      errorCode: 4001,
                      errorMessage: "Input yang tidak valid disediakan. Periksa format data Anda.",
                      errorDetails: [{
                        field: "parameterName",
                        issue: "Nilai tidak boleh kosong",
                        suggestedAction: "Isi semua parameter yang wajib."
                      }],
              ...
              "application/json": {
                ...
                examples: {
                  resourceNotFound: {
                    value: {
                      errorCode: 4040,
                      errorMessage: "Sumber daya tidak ditemukan. Verifikasi ID atau jalur yang Anda gunakan.",
                      correlationId: "1a2b3c4d-5e6f-7890-1234-567890abcdef"
                    }
                  }
                }
              }
              ...
              "application/json": {
                ...
                examples: {
                  serverCrash: {
                    value: {
                      errorCode: 5e3,
                      errorMessage: `Gangguan sistem terdeteksi: Error server internal ${domainName}.`,
            ...
            content: {
              "application/json": {
                ...
                examples: {
                  asyncJobInitiated: {
                    value: {
                      confirmationMessage: "Tugas asinkron berhasil diinisiasi.",
                      jobId: "e1f2g3h4-i5j6-7890-abcd-ef0123456789",
                      statusUrl: `https://api.${domainName}/v1/jobs/e1f2g3h4-i5j6-7890-abcd-ef0123456789/status`
                    }
                  }
                }
              }
          ...
          operationObject.requestBody = {
            ...
            content: {
              "application/json": {
                ...
                examples: {
                  examplePayload: {
                    value: parameters.reduce((acc, {
                      name: paramName
                    }) => {
                      if (paramName) acc[paramName] = `data_for_${paramName}_at_${domainName}`;
                      return acc;
                    }, {})
                  },
                  detailedPayload: {
                    summary: `Contoh Muatan Data untuk ${domainName} Modul`,
                    value: {
                      moduleName: "Dynamic_Reporting_Module",
                      version: "1.0.0",
                      isActive: true,
                      configuration: {
                        reportType: "summary",
                        deliveryMethod: "api_callback"
                      },
                      requestedBy: `user@${domainName}`
                    }
                  }
                }
              }
